...
%   LABELING, optional initial labeling given as a matrix of the size
...
%% %%%%%%%% HELPING FUNCTIONS %%%%%%%%%%
    ...
    function save_displayed
        ...
        if ~isequal(file,0) && ~isequal(path,0)
            ...
            imwrite(LABELING_OVERLAY,[roothname,'_labeling_displayed.png'])
    ...
    function export_LS
        ...
        if strcmp(button,'OK')
            ...
            assignin('base','gui_dictprob',T1*PROBABILITY)
